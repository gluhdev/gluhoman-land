        ...
        <article className="max-w-3xl mx-auto px-6 text-[#0f1f18]/80 leading-relaxed">
          ...
          <section className="border-t border-[#e6d9b8]/60 pt-12 mt-12">
            ...
            <ul className="mt-5 space-y-3 list-none">
              <li className="flex gap-3">
                ...
                <span>{t("section_2.item_1")}</span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-1 w-3 flex-none bg-[#e6d9b8]" />
                <span>{t("section_2.item_2")}</span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-1 w-3 flex-none bg-[#e6d9b8]" />
                <span>{t("section_2.item_3")}</span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-1 w-3 flex-none bg-[#e6d9b8]" />
                <span>{t("section_2.item_4")}</span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-1 w-3 flex-none bg-[#e6d9b8]" />
                <span>{t("section_2.item_5")}</span>
              </li>
            </ul>
          </section>
          ...
          <section className="border-t border-[#e6d9b8]/60 pt-12 mt-12">
            ...
            <h3 className="font-display text-xl text-[#1a3d2e]/80 mt-4 mb-3">
              {t("section_3.subheading_1")}
            </h3>
            <p>{t("section_3.body_p1")}</p>
            <h3 className="font-display text-xl text-[#1a3d2e]/80 mt-6 mb-3">
              {t("section_3.subheading_2")}
            </h3>
            <p>{t("section_3.body_p2")}</p>
          </section>

          <section className="border-t border-[#e6d9b8]/60 pt-12 mt-12">
            <SectionHeading numeral={ROMAN[3]} title={t("section_4.heading")} />
            <p>{t("section_4.body")}</p>
          </section>
          ...
          <section className="border-t border-[#e6d9b8]/60 pt-12 mt-12">
            ...
            <ul className="mt-5 space-y-3 list-none">
              <li className="flex gap-3">
                <span className="mt-2 h-1 w-3 flex-none bg-[#e6d9b8]" />
                <span>
                  <strong className="text-[#1a3d2e]">{t("section_5.quiet_label")}</strong>{" "}
                  {t("section_5.quiet_body")}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-1 w-3 flex-none bg-[#e6d9b8]" />
                <span>
                  <strong className="text-[#1a3d2e]">{t("section_5.smoking_label")}</strong>{" "}
                  {t("section_5.smoking_body")}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-1 w-3 flex-none bg-[#e6d9b8]" />
                <span>
                  <strong className="text-[#1a3d2e]">{t("section_5.pets_label")}</strong>{" "}
                  {t("section_5.pets_body")}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-1 w-3 flex-none bg-[#e6d9b8]" />
                <span>{t("section_5.property_body")}</span>
              </li>
            </ul>
          </section>
          ...
          <section className="border-t border-[#e6d9b8]/60 pt-12 mt-12">
            <SectionHeading numeral={ROMAN[7]} title={t("section_8.heading")} />
            <p>{t("section_8.body")}</p>
          </section>
        </article>
      </section>
