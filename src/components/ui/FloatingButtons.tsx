...
export default function FloatingButtons() {
  ...
  const contactOptions = [
    ...
    },
    {
      ...
      action: () => window.open(`https://wa.me/${phoneDigits}?text=${encodeURIComponent(t('whatsapp_message'))}`, '_blank'),
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        title={showContactOptions ? t('close_title') : t('open_title')}
      >
        {showContactOptions ? (
          <X className="h-6 w-6" />
        ) : (
