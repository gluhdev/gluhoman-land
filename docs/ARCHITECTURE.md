...
> ⚠️ **STALE / УСТАРЕЛО.** Этот документ описывает раннюю 4-страничную версию сайта (до i18n, до БД, до админки и бронирований). Актуальная структура — в наборе [`docs/MAP-*.md`](README.md), начиная с [`MAP-OVERVIEW.md`](MAP-OVERVIEW.md). Оставлен для истории.
